        ...
        require('catppuccin').setup({
            ...
            custom_highlights = function(colors)
                return {
                    ...
                    -- Replacte treesitter's highlights for vimtex
                    texCmdAuthor = { fg = colors.yellow, style = { 'bold' } },
                    texAuthorArg = { fg = colors.blue },
                    texCmdTitle = { fg = colors.yellow, style = { 'bold' } },
                    texTitleArg = { fg = colors.blue },
                    texCmdEnv = { fg = colors.yellow, style = { 'bold' } },
                    texEnvArgName = { fg = colors.sapphire },
                    ...
                    texRefArg = { fg = colors.lavender },
                    texCmd = { fg = colors.blue },
                    texMathCmd = { fg = colors.mauve },
                    ...
                    texMathError = { fg = colors.red, style = { 'underline' } },
                    MatchParen = { fg = colors.peach, bg = colors.surface0, style = { 'bold' } },
                    -- texStyleItal = { fg = colors.red, style = { 'italic' } },
                    -- texStyleBold = { fg = colors.red, style = { 'bold' } },
                    -- texMathStyleItal = { fg = colors.red, style = { 'italic' } },
                    -- texMathStyleBold = { fg = colors.red, style = { 'bold' } },
                    texStyleItal = { style = { 'italic' } },
                    texMathStyleItal = { style = { 'italic' } },
                    texStyleBold = { style = { 'bold' } },
                    texMathStyleBold = { fg = colors.blue, style = { 'bold' } },
                    texCmdNewCmd = { fg = colors.yellow },
                    texNewCmdOpt = { fg = colors.flamingo },
            ...
            integrations = {
                ...
                lsp_trouble = true,
                copilot_vim = true,
                -- For more plnugins integrations please scroll down (https://github.com/catppuccin/nvim#integrations)
            },
        })
    end,
}
